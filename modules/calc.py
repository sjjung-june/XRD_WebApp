...
def grain_size(SN, Year, Month, File_List, Peak_Pos, Peak_Height):    
    ...
    for idx in range(len(File_List)):
        ...
        result = {"File": File_List[idx], "FWHM" : halfwidths, "Grain Size" : grains, "Peak": Pos.tolist()}
